     ...
     <div class="row"> 
      <div class="col-sm-6"> 
       <div class="bk-margin-bottom-10"> 
        <button id="addToTable" class="btn btn-info">列表 <i class="fa fa-plus"></i></button> 
       </div> 
      </div> 
     </div> 
       ...
       <table class="table table-bordered table-striped mb-none dataTable no-footer" id="datatable-editable" role="grid" aria-describedby="datatable-editable_info"> 
        <thead> 
         <tr role="row">
          ...
          <th class="sorting" tabindex="0" aria-controls="datatable-editable" rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending" style="width: 325px;">管理员姓名</th>
          <th class="sorting" tabindex="0" aria-controls="datatable-editable" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending" style="width: 369px;">头像</th>
        ...
        <tbody> 
         ...
         <tr class="gradeA even" role="row"> 
          ...
          <td class="actions"> 
            <form action="/adminsuser/{{$row->id}}" method="post">
            {{csrf_field()}}
              {{method_field("DELETE")}}
                <button class="bk-margin-5 btn btn-danger btn-circle" type="submit"><i class="fa fa-times"></i></button>
              
            </form>
             <a href="/adminsuser/{{$row->id}}/edit" class="bk-margin-5 btn btn-warning btn-circle"><i class="fa fa-pencil-square-o"></i></a>
